...
// ---------------------------------------------------------------------------
// Comparison benchmarks: prompt-templates (Rust/CGo) vs Go text/template
//
...
// "Go_" prefixed benchmarks; prompt-templates benchmarks are already
// defined in prompt_templates_bench_test.go.
// ---------------------------------------------------------------------------
