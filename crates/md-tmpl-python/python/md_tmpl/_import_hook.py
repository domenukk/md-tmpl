...
After calling ``md_tmpl_import_hook()``, you can import typed
...
Configuration:
    ...
    ``md_tmpl_import_hook(search_paths=["prompts/", "other/"])``
...
def md_tmpl_import_hook(
    ...
    Example::
        ...
        md_tmpl_import_hook(search_paths=["prompts/", "templates/"])
...
class _TemplateLoader(importlib.abc.Loader):
    ...
    def exec_module(self, module: types.ModuleType) -> None:
        ...
        from md_tmpl._md_tmpl import Template
