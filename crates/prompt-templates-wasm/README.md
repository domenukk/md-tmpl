# prompt-templates-wasm

WebAssembly bindings for the
[prompt-templates](https://github.com/domenukk/prompt-templates) engine.
...
`prompt-templates` package — swap backends without changing application
code.
...
```ts
import { Template } from "./pkg/prompt_templates_wasm";
...
import { Template as TsTemplate } from "prompt-templates";
