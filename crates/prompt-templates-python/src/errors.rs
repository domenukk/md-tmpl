...
//!
//! The Python exceptions live in `prompt_templates._exceptions` and mirror
//! the Rust enum:
//!
...
use prompt_templates::TemplateError;
use pyo3::prelude::*;
...
pub(crate) fn template_error_to_py(err: &TemplateError) -> PyErr {
    Python::attach(|py| {
        ...
        let Ok(exc_mod) = py.import("prompt_templates._exceptions") else {
