/**
 * Correctness tests: WASM vs pure-TypeScript md-tmpl.
 *
...
const { Template: WasmTemplate } = require("../pkg/md_tmpl_wasm.js");
...
console.log("md-tmpl — Correctness Tests (WASM vs TS)");
